...
class LightsOutjava3 : AppCompatActivity() {
    val SIZE = 3
    val LIMIT = 0
    private var soundPlayer: SoundPlayer? = null
    var lights = Array(SIZE) { arrayOfNulls<ImageView>(SIZE) }

    /* HashMap は ImageView の ID（R.id.）と，画像（off：-1，on:0，×:1）のペア*/
    ...
    override fun onCreate(saveInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lightsoutjava3)
...
//        });
        val listener = View.OnClickListener { v: View ->
            ...
            if (AllOff()) {
                ...
                val success = Intent(this@LightsOutjava3, Success::class.java)
